<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/data/www/tp5blog/public/../application/index/view/index/index.html";i:1486310568;s:67:"/data/www/tp5blog/public/../application/index/view/public/base.html";i:1486310212;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>Home</title>
        ...
        <div class="main">
                    ...
                    <div class="navigation">
                        <div>
                            ...
                            <ul class="nav">
                                ...
                                <li><a href="cinema.html" class="color2">cinema</a></li>
                                <li><a href="magazine.html" class="color3">Magazine</a></li>
                                <li class="dropdown"><a href="#" class="color4">Topmenu<span> </span></a>
                                    <ul>
                                        <li><a href="cinema.html">cinema</a></li>
                                        <li><a href="magazine.html">Magazine</a></li>
                                    </ul>
                                </li>
                                <li><a href="archives.html" class="color5">Archives</a></li>
            ...
            <div class="gallery">
                ...
                <div id="owl-demo" class="owl-carousel ">
                    <div class="item g1">
                        <a href="single.html"><img class="lazyOwl " data-src="/static/images/pi.jpg" alt="name"></a>
                        <div class="caption">
                            <h3 class="cinema"><a href="single.html">CINEMA</a></h3>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting</p>
                        </div>
                    </div>
                    <div class="item g1">
                        <a href="single.html"><img class="lazyOwl" data-src="/static/images/pi2.jpg" alt="name"></a>
                        <div class="caption">
                            <h3 class="cinema travel"><a href="single.html">Travel</a></h3>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting</p>
                        </div>
                    </div>
                    <div class="item g1">
                        <a href="single.html"><img class="lazyOwl" data-src="/static/images/pi1.jpg" alt="name"></a>
                        <div class="caption">
                            <h3 class="cinema tele"><a href="single.html">television</a></h3>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting</p>
                        </div>
                    </div>
                    <div class="item g1">
            ...
            <div class="content">
                <div class="col-md-8 content-top">
                    <div class="number">
                        ...
                        <h3><a href="single.html">Lorem Ipsum is simply dummy text of the printing </a></h3>
                                    ...
                                    <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                                        <div class="resp-tabs-container">
                                            ...
                                            <div class="tab-1 resp-tab-content " aria-labelledby="tab_item-0">
                                                <div class="facts">
                                                    <img src="/static/images/pc.jpg" class="img-responsive" alt="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-1 resp-tab-content resp-tab-content-active" aria-labelledby="tab_item-1" >
                                                <div class="facts">
                                                    <img src="/static/images/pc1.jpg" class="img-responsive" alt="">
                                                </div>
                                            </div>
                                            <h2 class="resp-accordion" role="tab" aria-controls="tab_item-2"><span class="resp-arrow"></span></h2>
                                            <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
                                                <div class="facts">
                                                    <img src="/static/images/pc2.jpg" class="img-responsive" alt="">
                                                </div>
                                            </div>
                                            <h2 class="resp-accordion" role="tab" aria-controls="tab_item-3"><span class="resp-arrow"></span></h2>
                                            <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">
                                                <div class="facts">
                                                    <img src="/static/images/pc3.jpg" class="img-responsive" alt="">

                                                </div>
                                            </div>
                                        </div>
                                        <ul class="resp-tabs-list">
                                            <li class="resp-tab-item resp-tab-active" aria-controls="tab_item-0" role="tab"><span><img src="/static/images/pic.jpg" class="img-responsive" alt=""></span></li>
                                            <li class="resp-tab-item " aria-controls="tab_item-1" role="tab"><span><img src="/static/images/pic1.jpg" class="img-responsive" alt=""></span></li>
                                            <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span><img src="/static/images/pic2.jpg" class="img-responsive" alt=""></span></li>
                                            <li class="resp-tab-item" aria-controls="tab_item-3" role="tab"><span><img src="/static/images/pic3.jpg" class="img-responsive" alt=""></span></li>
                                            <div class="clearfix"> </div>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="sap_tabs">
                                    <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                                        <div class="resp-tabs-container">
                                            ...
                                            <div class="tab-1 resp-tab-content " aria-labelledby="tab_item-0">
                                                <div class="facts">
                                                    <img src="/static/images/fa.jpg" class="img-responsive" alt="">
                                                </div>
                                            </div>
                                            <h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-1"><span class="resp-arrow"></span></h2>
                                            <div class="tab-1 resp-tab-content resp-tab-content-active" aria-labelledby="tab_item-1" >
                                                <div class="facts">
                                                    <img src="/static/images/fa1.jpg" class="img-responsive" alt="">
                                                </div>
                                            </div>
                                            <h2 class="resp-accordion" role="tab" aria-controls="tab_item-2"><span class="resp-arrow"></span></h2>
                                            <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
                                                <div class="facts">
                                                    <img src="/static/images/fa2.jpg" class="img-responsive" alt="">
                                                </div>
                                            </div>
                                            <h2 class="resp-accordion" role="tab" aria-controls="tab_item-3"><span class="resp-arrow"></span></h2>
                                            <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">
                                                <div class="facts">
                                                    <img src="/static/images/fa3.jpg" class="img-responsive" alt="">

                                                </div>
                                            </div>
                                        </div>
                                        <ul class="resp-tabs-list">
                                            <li class="resp-tab-item resp-tab-active" aria-controls="tab_item-0" role="tab"><span><img src="/static/images/f1.jpg" class="img-responsive" alt=""></span></li>
                                            <li class="resp-tab-item " aria-controls="tab_item-1" role="tab"><span><img src="/static/images/f2.jpg" class="img-responsive" alt=""></span></li>
                                            <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span><img src="/static/images/f3.jpg" class="img-responsive" alt=""></span></li>
                                            <li class="resp-tab-item" aria-controls="tab_item-3" role="tab"><span><img src="/static/images/f4.jpg" class="img-responsive" alt=""></span></li>
                                            <div class="clearfix"> </div>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="col-md-4 content-bottom">
                    <div class="story"><h4  class="stories"><span>Top Stories</span></h4></div>
                    <!---->
                    <div class="cd-tabs">
                        <nav>
                            <ul class="cd-tabs-navigation">
                                <li><a data-content="fashion"  href="#0">fashion <i> </i></a></li>
                                <li><a data-content="cinema" href="#0" class="selected fashion1">cinema<i> </i></a></li>
                                <li><a data-content="television" href="#0" class="fashion2">television<i> </i></a></li>
                        ...
                        <ul class="cd-tabs-content">
                            <li data-content="fashion" >
                                <div class="top-men">
                                    <div class="men">
                                        <div class="grid-men">
                                            <a href="single.html"><img src="/static/images/pp1.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="men-grid">
                                    ...
                                    <div class="men">
                                        <div class="grid-men">
                                            <a href="single.html"><img src="/static/images/pp11.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="men-grid">
                                            <h5><a href="single.html">Lorem Ipsum is simply dummy text of the printing </a></h5>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's </p>
                                    ...
                                    <div class="men">
                                        <div class="grid-men">
                                            <a href="single.html"><img src="/static/images/pp12.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="men-grid">
                                            <h5><a href="single.html">Lorem Ipsum is simply dummy text of the printing </a></h5>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's </p>
                            ...
                            <li data-content="cinema" class="selected">
                                <div class="top-men">
                                    <div class="men">
                                        <div class="grid-men">
                                            <a href="single.html"><img src="/static/images/pp.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="men-grid">
                                            <h5><a href="single.html">Lorem Ipsum is simply dummy text of the printing </a></h5>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's </p>
                                    ...
                                    <div class="men">
                                        <div class="grid-men">
                                            <a href="single.html"><img src="/static/images/pp0.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="men-grid">
                                            <h5><a href="single.html">Lorem Ipsum is simply dummy text of the printing</a> </h5>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's </p>
                                    ...
                                    <div class="men">
                                        <div class="grid-men">
                                            <a href="single.html"><img src="/static/images/pp01.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="men-grid">
                                            <h5><a href="single.html">Lorem Ipsum is simply dummy text of the printing </a></h5>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's </p>
                            ...
                            <li data-content="television" >
                                <div class="top-men">
                                    <div class="men">
                                        <div class="grid-men">
                                            <a href="single.html"><img src="/static/images/pp2.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="men-grid">
                                            <h5><a href="single.html">Lorem Ipsum is simply dummy text of the printing </a></h5>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's </p>
                                    ...
                                    <div class="men">
                                        <div class="grid-men">
                                            <a href="single.html"><img src="/static/images/pp21.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="men-grid">
                                            <h5><a href="single.html">Lorem Ipsum is simply dummy text of the printing </a></h5>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's </p>
                                    ...
                                    <div class="men">
                                        <div class="grid-men">
                                            <a href="single.html"><img src="/static/images/pp22.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="men-grid">
                                            <h5><a href="single.html">Lorem Ipsum is simply dummy text of the printing</a> </h5>
                                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's </p>
                    ...
                    <div class="might">
                        ...
                        <div class="might-grid">
                            <div class="grid-might">
                                <a href="single.html"><img src="/static/images/mi.jpg" class="img-responsive" alt=""> </a>
                            </div>
                            <div class="might-top">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                <a href="single.html">Medication <i> </i></a>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="might-grid">
                            <div class="grid-might">
                                <a href="single.html"><img src="/static/images/mi1.jpg" class="img-responsive" alt=""> </a>
                            </div>
                            <div class="might-top">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                <a href="single.html">Medication <i> </i></a>
                        ...
                        <div class="might-grid">
                            <div class="grid-might">
                                <a href="single.html"><img src="/static/images/mi2.jpg" class="img-responsive" alt=""> </a>
                            </div>
                            <div class="might-top">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                <a href="single.html">Medication <i> </i></a>
                        ...
                        <div class="might-grid">
                            <div class="grid-might">
                                <a href="single.html"><img src="/static/images/mi3.jpg" class="img-responsive" alt=""> </a>
                            </div>
                            <div class="might-top">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                <a href="single.html">Medication <i> </i></a>
